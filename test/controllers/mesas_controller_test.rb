...
class MesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post mesas_url, params: { mesa: { integer: @mesa.integer, numeroSillas: @mesa.numeroSillas, ocupado: @mesa.ocupado, sillas: @mesa.sillas } }
    end
  ...
  test "should update mesa" do
    patch mesa_url(@mesa), params: { mesa: { integer: @mesa.integer, numeroSillas: @mesa.numeroSillas, ocupado: @mesa.ocupado, sillas: @mesa.sillas } }
